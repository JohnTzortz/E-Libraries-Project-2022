...
<html>
    <head>
        ...
        <link rel="stylesheet" href="librarianRegister.css">
    ...
    <body>
        ...
        <form action="../../java/servlets/librarians/forTest.java" method="POST" class="my-form" onsubmit="return checkSub();">
            <legend>
                <center>
                    <h2><b>Registration Form </b>(Librarian)</h2>
            ...
            <div id="libraryNameDivId">
                <label class="col-md-8 control-label" ><p class="red_star">*</p>Library Name</label>
                <div class="col-md-6 inputGroupContainer">
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input name="libraryname" id="library_name_id" placeholder="e.g. Bodleian Library" class="form-control" type="text">
                </div>
                </div>                
            </div>
            ...
            <div class="form-group col-md-6" id="libraryInfoDivId">
                <label for="exampleFormControlTextarea1"><p class="red_star">*</p>Information about the Library</label>
                <textarea class="form-control" name="libraryinfo" id="library_info_id" rows="3"></textarea>
              </div>
        ...
        <div class="form-group" id="personalSiteDivId">
          ...
          <input type="hidden" id="lon_id" name="lon_name" value="">
     ...
     <div class="container">
      <footer class="py-3 my-4">
        ...
        <script src="/Project2022_E-Libraries/librarian/librarianRegister.js"></script>
    </body>
</html>
<script>
    $(document).ready(function(){
        ...
        $('#libraryNameDivId').hide();
        $('#libraryInfoDivId').hide();
       ...
       if($('#step').text() === "Step 2"){
            ...
            if($('#step').text() === "Step 3"){
                ...
                if($('#step').text() === "Step 4- Finale Step!"){
                    $('#libraryNameDivId').show();
                    $('#libraryInfoDivId').show();
    ...
    function checkSub(){
     // alert($("#flexCheckDefault").is(':checked'));
...
<style><%@ include file="librarianRegister.css"%></style>
