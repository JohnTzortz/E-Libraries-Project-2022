...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/Project2022_E-Libraries/librarian/librarianProfile.css">
    ...
    <body>
        ...
        <%
            ...
            while (result.next()) {
                    if (session.getAttribute("savedusername").equals(result.getString("username"))) {
                        ...
                        result.getString("libraryname"),
                        result.getString("libraryinfo"), 
        ...
        <form id="librarianUpdate" method="post" action="librarianUpdate">
            <fieldset id="fields" disabled="disabled">
                <label for="username">Username:</label><br>
                    <input id="username" name="username" type="text" value= <%= librarian.getUsername() %> readonly><br>
                <label for="email">e-mail:</label><br>
                    <input id="email" name="email" type="email" value= <%= librarian.getEmail() %> readonly><br>
                ...
                <label for="firstname">First Name:</label><br>
                    <input id="firstname" name="firstname" type="text" minlength="3" maxlength="30" required value= <%= librarian.getFirstname() %>><br>
                <label for="lastname">Last Name:</label><br>
                    <input id="lastname" name="lastname" type="text" minlength="3" maxlength="30" required value= <%= librarian.getLastname() %>><br>
                <label for="birthdate">Date of Birth:</label><br>
                    <input id="birthdate" name="birthdate" type="date" value=<%= librarian.getBirthdate() %> min="1920-01-01" max="2006-12-31" required><br>
                <label>Gender:</label>
                <%
                ...
                <label for="personalpage">Personal page:</label><br>
                    <input type="url" id="personalpage" name="personalpage" value = <%= librarian.getPersonalpage() == null ? "" : librarian.getPersonalpage() %>><br>
                <label for="country">Country:</label><br> 
                <select id="country" name="country">
                    <option selected value = <%= librarian.getCountry() %>><%= librarian.getCountry() %></option>
                ...
                <label for="city">City:</label><br>
                    <input type="text" id="city" name="city" minlength="3" maxlength="50" required value = <%= librarian.getCity() %>><br>
                <label for="address">Address:</label><br>
                    <input type="text" id="address" name="address" minlength="3" maxlength="50" required value = <%= librarian.getAddress() %>><br>
                <label for="libraryname">Library Name:</label><br>
                    <input type="text" id="libraryname" name="libraryname" readonly value = <%= librarian.getLibraryname() %>><br>
                <label for="libraryinfo">Library Info:</label><br>
                    <textarea id="libraryinfo" name="libraryinfo" rows="4" cols="50" required><%= librarian.getLibraryinfo() %> </textarea><br>
                <label for="telephone">Telephone Number:</label><br>
                    <input type="tel" id="telephone" name="telephone" minlength="10" maxlength="14" required value = <%= librarian.getTelephone() %>><br>
        ...
        <script src="/Project2022_E-Libraries/librarian/librarianProfile.js"></script>
    </body>
</html>
